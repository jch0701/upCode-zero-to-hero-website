...
import { RecommendedProject } from "./page/roadmaps/Recommendation/Project.tsx";
import { RecommendedCareer } from "./page/roadmaps/Recommendation/Career.tsx";
    ...
    <>
      <Routes location={state?.backgroundLocation || location}>
        <Route path="/" element={<RootLayout />}>
          ...
          <Route path="roadmap/:roadmapID/:roadmapSlug/:chapterID/:chapterSlug/recommend-project" element={<RecommendedProject />} />
          <Route path="roadmap/:roadmapID/:roadmapSlug/:chapterID/:chapterSlug/recommend-career" element={<RecommendedCareer />} />
