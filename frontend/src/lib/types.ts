...
export const categoryList: any[] = ["Web Development", "Mobile Apps", "Machine Learning", "Game Development", "Data Science", "DevOps", "Cloud Computing", "Cybersecurity", "Embedded Systems", "AR/VR", "Blockchain", "IoT", "NLP"];
